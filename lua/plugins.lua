...
local function init()
  ...
  use {'folke/zen-mode.nvim', config = "require('plugins.zen')", disable = not GlobalConfig.plugins.zen.enabled}
  use {'folke/twilight.nvim', config = function() require("twilight").setup {} end, disable = not GlobalConfig.plugins.zen.enabled}
  ...
  use {'vuki656/package-info.nvim', disable = not GlobalConfig.plugins.package_info.enabled}
