...
local handlers =  {
  ["textDocument/hover"] =  vim.lsp.with(vim.lsp.handlers.hover, {border = GlobalConfig.ui.float.border}),
  ["textDocument/signatureHelp"] =  vim.lsp.with(vim.lsp.handlers.signature_help, {border = GlobalConfig.ui.float.border}),
}
...
lsp_installer.on_server_ready(function(server)
    ...
    -- TODO: Add installer for new servers
